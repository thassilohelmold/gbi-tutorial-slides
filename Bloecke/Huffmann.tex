...
\begin{frame}{Huffman-Codes}
		...
		\begin{Beispiel}
			...
			Erstellt eine Huffman-Codierung für jedes Wort und codiert $w_1$ mit mit beiden Codierungen.\\
...
\begin{frame}{Huffman-Codes}
	...
	\begin{Beispiel}
		$w_1 = \word{badcfehg}, \quad w_2 = \word a^1 \word b^2 \word c^4 \word d^8 \word e^{16} \word f^{32} \word g^{64} \word h^{128}$. \\
		Erstellt eine Huffman-Codierung für jedes Wort und codiert beide mit mit beiden Codierungen.\\
		Was verhalten sich die Längen der Codewörter?
	\end{Beispiel}
\end{frame}
