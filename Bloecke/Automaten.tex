...
\begin{frame}{Beispiel: Umwandlung von Mealy nach Moore}
	...
	;
	\draw[->] (A) to[out=-90,in=-76, looseness=1.94] (M) node [at start, below=55pt, right=4pt] { 2}; %Fuck you, LaTeX. "midway" node option doesn't work at all.
	\end{tikzpicture}
\end{frame}

\begin{frame}{Aufgabe: Textersetzung mit Automaten}
	\begin{block}{Aufgabe}
		Geg.: \quad $w \in \set{\word a, \word b}^*$, wobei $w$ nicht auf \word{ba} endet und $w \neq \word a$ ist. \\
