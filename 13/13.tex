...
\begin{frame}{Wahr oder Falsch?}
	\begin{itemize}
		\truefalseQ{1}{myRed}{Das (komplizierte) Master-Theorem kann man immer anwenden.}{F \newline Nur bei rekursiven Algorithmen, bei denen das Problem in gleich große Teilprobleme aufgeteilt wird.}
		\truefalseQ{3}{myRed}{Jeder Moore-Automat kann in einen Mealy-Automat gewandelt werden, der für jedes Wort die gleiche Ausgabe produziert.}{F \newline Für das leere Wort kann ein Mealy-Automat niemals eine Ausgabe produzieren.}
		\truefalseQ{5}{myGreen}{Endliche Akzeptoren sind Moore-Automaten mit dem Ausgabealphabet $\{0, 1\}$}{W}
		\truefalseQ{7}{myRed}{Mit endlichen Automaten kann jede beliebige Sprache erkannt werden}{F $\quad$ Tatsächlich ist die Menge der akzeptierbaren Sprachen sogar sehr eingeschränkt.}
	\end{itemize}
\end{frame}
