...
\begin{frame}
	\begin{block}{Wahr oder Falsch?}
		\begin{itemize}
			\truefalseQ{1}{myRed}{Eine Funktion muss linkseindeutig sein}{F \\ Richtig: Eine Funktion muss rechtseindeutig und linkstotal sein}
			\truefalseQ{3}{myGreen}{Eine injektive Funktion ist linkseindeutig}{W}
			\truefalseQ{5}{myGreen}{Eine surjektive Funktion ist rechtstotal}{W}
			\truefalseQ{7}{myRed}{Jede Relation ist eine Funktion}{F}
			\truefalseQ{9}{myGreen}{Jede Funktion ist eine Relation}{W}
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
	\begin{block}{Wahr oder Falsch?}
	\begin{itemize}
		\truefalseQ{1}{myRed}{$aaba \in \{a,b\}^2\times\{a,b\}^2$}{F $\quad$Aber: $(\text{aa}, \text{ba}) \in \{a,b\}^2\times\{a,b\}^2$}
		\truefalseQ{3}{myRed}{Ich benutze für jeden Beweis Induktion.}{F\\ Mit einem Schraubenschlüssel bekommt man keinen Nagel in die Wand.}
		\truefalseQ{5}{myRed}{$\setsize{\{ \varepsilon \}} = 0$}{F $\quad \{ \varepsilon \} \neq \emptyset$}
	\end{itemize}
	\end{block}
\end{frame}
