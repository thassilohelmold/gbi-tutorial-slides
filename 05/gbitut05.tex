...
\begin{frame}[t]{Wahr oder falsch?}
	...
	\FalseQuestionE{$x \boder y = y \boder x$}{Das sind syntaktisch verschiedene AL-Formeln}
	\TrueQuestion{$x \boder y \equiv y \boder x$}
	\TrueQuestion{Das AL-Kalkül ist vollständig und korrekt}
	\FalseQuestion{$\bleftBr G \bimp H \brightBr \; \vdash \;  \bleftBr H \bimp G \brightBr$}
