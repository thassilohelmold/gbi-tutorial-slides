...
\begin{frame}
	...
	\begin{itemize}
		\truefalseQ{1}{2}{myGreen}{$\forall x \in \nZ : x \mod 2 = 0 \iff x \text{ ist gerade}$}{W $\qquad \text{Und auch: } x \mod 2 = 1 \iff \text{x ist ungerade}$}
		\truefalseQ{3}{4}{myRed}{$4 \cdot (x \div 4) = x$}{F $\qquad 4 \cdot (x \div 4) + (x \mod 4) = x$}
		\truefalseQ{5}{6}{myGreen}{$\left(\{a\}^\ast\cdot \{b,\epsilon\}\right)^\ast = \{a,b\}^\ast$}{W}
		\truefalseQ{7}{8}{myRed}{Jede Abbildung besitzt eine Umkehrabbildung}{F Nur bijektive Abbildungen besitzen eine Umkehrabbildung}
		\truefalseQ{9}{10}{myGreen}{Für jede Abbildung können wir das Urbild angeben}{W}
	\end{itemize}
	\end{block}	
\end{frame}
