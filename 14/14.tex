...
\begin{frame}{Wahr oder Falsch?}
	\begin{itemize}
		\truefalseQ{1}{myRed}{Jede kontextfreie Grammatik lässt sich als regulärer Ausdruck darstellen}{F $\qquad$ Die Grammatik muss rechtslinear sein, kontextfrei kann \enquote{mehr}}
		\truefalseQ{3}{myGreen}{Jeder regulären Ausdruck lässt sich durch eine kontextfreie Grammatik darstellen}{W}
		\truefalseQ{5}{myGreen}{Für jede Sprache $L$ und jedes Wort $w \in L$ gilt: Es existiert ein endlicher Automat, der $w$ erkennt}{W}
		\truefalseQ{7}{myRed}{Die Sprache der gültigen Klammerausdrücke ist regulär}{F}
		\truefalseQ{9}{myGreen}{Die Sprache der gültigen Klammerausdrücke ist kontextfrei}{W}
	\end{itemize}
\end{frame}
