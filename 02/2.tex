...
\begin{frame}
	\begin{block}{Wahr oder Falsch?}
		\begin{itemize}
			\truefalseQ{1}{myGreen}{$ \setsize{\emptyset} = 0$}{W}
			\truefalseQ{3}{myRed}{$ \setsize{ \{ \{ \; \} \} } = 0$}{F: $ \setsize{ \{ \{ \; \} \} } = \setsize{\{\emptyset\}} =1$}
			\truefalseQ{5}{myGreen}{$ \{1, 2\} = \{2, 1\}$}{W}
			\truefalseQ{7}{myRed}{$ (1, 2) = (2, 1)$}{F}
			\truefalseQ{9}{myRed}{$ \left(M\cup A\right)\setminus M = A $}{F: $ M = A = \{1\}$}
		\end{itemize}
	\end{block}
