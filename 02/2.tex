...
\begin{frame}
	\begin{block}{Wahr oder Falsch?}
		\begin{itemize}
			\truefalseQ{1}{2}{MYgreen}{$ \setsize{\emptyset} = 0$}{W}
			\truefalseQ{3}{4}{MYorange}{$ \setsize{ \{ \{ \; \} \} } = 0$}{F: $ \setsize{ \{ \{ \; \} \} } = \setsize{\{\emptyset\}} =1$}
			\truefalseQ{5}{6}{MYgreen}{$ \{1, 2\} = \{2, 1\}$}{W}
			\truefalseQ{7}{8}{MYorange}{$ (1, 2) = (2, 1)$}{F}
			\truefalseQ{9}{10}{MYorange}{$ \left(M\cup A\right)\setminus M = A $}{F: $ M = A = \{1\}$}
		\end{itemize}
	\end{block}
