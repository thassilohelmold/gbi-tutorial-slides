...
\thasse{
	\begin{frame}{Achtung: Feiertag!}
	\begin{itemize}
		\item Nächsten Dienstag ist Feiertag
		\item Daher: \textbf{Kein Tutorium}!
		\item Aber: Themen werden \textbf{NICHT} nachgeholt (Folien im ILIAS)!
		\item Bitte anderes Tutorium besuchen (Empfehlung: Daniel Jungkind)
	\end{itemize}		 
	\end{frame}
}
...
\begin{frame}
	...
	\begin{block}{Was nächstes Mal kommt}
		\begin{itemize}
			\thasse{\item \textbf{Feiertag}: Kein Tutorium, das würden wir machen:}
