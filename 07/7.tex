...
\begin{frame}{Wahr oder Falsch?}
	\begin{block}{}
	\begin{itemize}
		\truefalseQ{1}{myRed}{Alle Vögel haben die gleiche Farbe}{F (siehe Termin 6)}
		\truefalseQ{3}{myRed}{Im IR der MIMA wird die Adresse des aktuellen Befehls gespeichert}{F\\ Das geschieht im IAR. Im IR steht der Befehl selbst}
		\truefalseQ{5}{myGreen}{Die Befehlsholphase ist jede Ausführungsrunde identisch}{W}
		\truefalseQ{7}{myRed}{Der Akku führt bei der MIMA Berechnungen aus}{F\\ Das macht die ALU. Im Akku wird das letzte Ergebnis zwischengespeichert}
	\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{Wahr oder Falsch?}
	\begin{block}{}
		\begin{itemize}
			\truefalseQ{1}{myRed}{LDC -5 lädt -5 in den Akku}{F\\ LDC funktioniert nicht mit negativen Konstanten!}
			\truefalseQ{3}{myRed}{Mit der MIMA können wir Zufallszahlen erzeugen}{F\\ Die MIMA arbeitet rein deterministisch und damit ohne jeden Zufall.}
		\end{itemize}
		\visible<5>{
			\begin{figure}[H]
				\centering
